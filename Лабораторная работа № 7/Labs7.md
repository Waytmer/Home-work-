...
![](Screnshot/Screenshots_19.png)<br/>Рис.1 Код файла "main.cpp"<br/>
![](Screnshot/Screenshots_20.png)<br/>Рис.2 Справка "Show"<br/>
**16.В инспекторе проекта выберите файл «Формы» => «calculatorform.ui» и дважды счёлкните ЛКМ;**<br/>
![](Screnshot/Screenshots_21.png)<br/>Рис.3 То, что открылость после двойного нажатия на «calculatorform.ui»<br/>
**17.Вы попали на вкладку «Дизайн». На форме замените английский текст на русский. Пересоберите проект.**<br/>
![](Screnshot/Screenshots_22.png)<br/>Рис.4 Изменение ангийских слов на русские<br/>
![](Screnshot/Screenshots_23.png)<br/>Рис.5 Собранный результат<br/>
